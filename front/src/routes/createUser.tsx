    ...
    return (
        <div>
            <form class="container-login" method="post">
                ...
                <input class="input-login" type="text" name="correo" placeholder="correo" required />
            ...
            <div id="cuenta-creacion">¿Ya tienes cuenta? <strong><a href="/login">¡Inicia sesión!</a></strong></div>
